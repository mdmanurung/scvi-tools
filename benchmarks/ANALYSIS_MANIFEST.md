...
|------|------|----------|----------|--------|--------|
| B1: Label transfer | `run.py --task b1` | Macro-F1 | CytoVI k-NN | roider-e1000 3-seed ✓; nunez-inductive-e1000 RUNNING (PID 1520357, seed-0 epoch~92/1000 @16:00 CEST, →~07:00 Jul 1 all 3 seeds); roider-full PENDING | Roider Δ+0.121±0.040 ✅ gate; Nuñez Δ−0.013 ❌ FAILS on leaky labels (F-003, L-022); re-run in progress with inductive kNN annotation fix |
