...
Requires ``pip install scvi-tools[cytoanvi-mapping-qc]`` (mapqc). Not exported from the top-level
``cytoanvi`` package; import from ``scvi.external.cytoanvi.mapping_qc``.
"""
