...
| B5 3-seed auto-merge ARMED: job 25144367 (afterany dep on B5 s0/s1/s2) → roider_full_b5_sweep_multiseed.json; then repoint manifest B5 to it | high | in_progress | infrastructure | 2026-07-03 | mdmanurung | — |
